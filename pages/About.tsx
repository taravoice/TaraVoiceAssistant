      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-20">
        ...
        <div className="grid md:grid-cols-2 gap-12">
           <div className="bg-[#0097b2]/10 p-8 rounded-2xl border border-[#0097b2]/20">
              ...
              <p className="text-slate-700 leading-relaxed">
                To create a world where businesses can focus on their craft while an <strong>AI appointment setter</strong> seamlessly handles administrative burdens, ensuring every customer feels heard and valued instantly.
              </p>
           </div>
           <div className="bg-white p-8 rounded-2xl border border-slate-200">
              ...
              <p className="text-slate-700 leading-relaxed">
                 We aim to revolutionize customer engagement through innovative, scalable <strong>automated appointment scheduling</strong> that reduces costs, saves time, and enhances customer satisfaction for SMBs everywhere.
              </p>
           </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
           {content.images.aboutTeam && (
             <div className="md:w-1/2">
                <MediaRenderer 
                  ...
                  alt="Tara Voice Assistant Team developing AI call answering software" 
           ...
           <div className={`${content.images.aboutTeam ? 'md:w-1/2' : 'w-full'} space-y-4`}>
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                We noticed that small businesses were losing valuable leads simply because they couldn't answer the phone. Receptionists are expensive, and voicemail is often ignored. Tara was built to bridge this gap—providing an affordable, intelligent, and reliable <strong>AI virtual receptionist service</strong> for businesses that want to grow.
              </p>
           </div>
        </div>
        ...
        <div className="bg-slate-900 text-white rounded-3xl p-10 md:p-16 relative overflow-hidden">
           ...
           <div className="relative z-10">
              ...
              <p className="text-lg text-slate-300 max-w-3xl leading-relaxed mb-8">
                 We serve hardworking business owners in healthcare, home services, beauty, and wellness who need to manage appointments without being tied to the phone. Whether you are a solo practitioner or run a busy clinic, Tara acts as your dedicated <strong>AI phone agent for small business</strong>.
              </p>
           </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12">
           {content.images.aboutFuture && (
             <div className="md:w-1/2">
                <MediaRenderer 
                  ...
                  alt="Future of AI voice agent for customer service" 
                  className="rounded-2xl shadow-lg w-full h-auto object-cover"
                />
             </div>
           )}
           <div className={`${content.images.aboutFuture ? 'md:w-1/2' : 'w-full'} space-y-4`}>
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                Voice AI is just the beginning. We are constantly evolving Tara to understand deeper context, handle complex negotiations, and integrate with even more business tools. The future is proactive, not just reactive <strong>inbound call automation</strong>.
              </p>
           </div>
        </div>
      </div>
